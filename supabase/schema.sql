...
CREATE INDEX idx_emergency_events_created_at ON public.emergency_events(created_at);
CREATE INDEX idx_health_entries_user_id ON public.health_entries(user_id);
CREATE INDEX idx_health_entries_created_at ON public.health_entries(created_at);
